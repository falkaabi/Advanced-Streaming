# Source: https://stackoverflow.com/questions/58592291/how-to-capture-multiple-camera-streams-with-opencv
...
if __name__ == '__main__':
    ...
    # Stream links
    camera0 = f'rtsp://{username}:{password}@192.168.1.43:554/cam/realmonitor?channel=1&subtype=0'
    camera1 = f'rtsp://{username}:{password}@192.168.1.45/axis-media/media.amp'
    camera2 = f'rtsp://{username}:{password}@192.168.1.47:554/cam/realmonitor?channel=1&subtype=0'
    camera3 = f'rtsp://{username}:{password}@192.168.1.40:554/cam/realmonitor?channel=1&subtype=0'
    camera4 = f'rtsp://{username}:{password}@192.168.1.44:554/cam/realmonitor?channel=1&subtype=0'
    camera5 = f'rtsp://{username}:{password}@192.168.1.42:554/cam/realmonitor?channel=1&subtype=0'
    camera6 = f'rtsp://{username}:{password}@192.168.1.46:554/cam/realmonitor?channel=1&subtype=0'
    camera7 = f'rtsp://{username}:{password}@192.168.1.41:554/cam/realmonitor?channel=1&subtype=0'
